...
from src import fillReducedTable
...
def calculate_predictions_knn():
    ...
    algo.predict(120, 48, r_ui=1, verbose=True)
    algo.predict(120, 18, r_ui=4, verbose=True)
    algo.predict(120, 13, r_ui=2, verbose=True)
    algo.predict(120, 58, r_ui=3, verbose=True)
    """
